class OrdersController < ApplicationController
  ...
  def orders_params
    params.require(:order).permit(:subtotal, :total, :shipping_fee, :bill_name, :bill_address, :bill_phone, :order_state_id, :shipping_address, :shipping_phone, :shipping_name)
  end
end
